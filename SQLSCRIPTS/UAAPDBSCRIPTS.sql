...
INSERT INTO CART_TABLE (PRODUCT_ID, USER_ID, QUANTITY, CARTORDER_PRICE) VALUES (1, 1, 3, 10);
...
PRODUCT_TABLE.PRODUCT_IMG_LINK
FROM ORDER_TABLE JOIN PRODUCT_TABLE ON PRODUCT_TABLE.PRODUCT_ID = ORDER_TABLE.PRODUCT_ID
WHERE USER_ID=3 ORDER BY ORDER_TABLE.ORDER_DATE DESC, ORDER_TABLE.ORDER_DATE_COMPLETED DESC; --FOR USERS
