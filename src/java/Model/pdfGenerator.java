...
public class pdfGenerator {
    ...
    public void generateInventoryReport(PdfWriter writer, Document document, ResultSet data, OutputStream out, String email, HttpServletResponse response) {
        ...
        try {
            ...
            response.setHeader( "Content-Disposition", "attachment;filename=" + pdfTitle);
    ...
    public void pendingOrderReport(PdfWriter writer, Document document, ResultSet data, OutputStream out, String email, HttpServletResponse response) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("MM-dd-yy HH-mm-ss");
        Date dateNow = new Date();
        try {
    ...
    public void completedOrdersReport(PdfWriter writer, Document document, ResultSet data, OutputStream out, String email, HttpServletResponse response) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("MM-dd-yy HH-mm-ss");
        Date dateNow = new Date();
        try {
    ...
    public void salesReport(PdfWriter writer, Document document, ResultSet data, OutputStream out, String email, HttpServletResponse response) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("MM-dd-yy HH-mm-ss");
        Date dateNow = new Date();
        try {
    ...
    public void generateUserReport(PdfWriter writer, Document document, ResultSet data, OutputStream out, String email, HttpServletResponse response) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("MM-dd-yy HH-mm-ss");
        Date dateNow = new Date();
        try {
